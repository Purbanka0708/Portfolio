        ...
        <div className='container mx-auto px-8 md:px-16 lg:px-24'>
            ...
            <div className='flex flex-col md:flex-row items-center md:space-x-12'>
               ...
               <div className='flex-1'>
                <p className='text-lg mb-8'>I am a paasionate developer with a focus on building modern and responsive web applications.With a strong foundation in both frontend and backend technologies,I strive to create seamless and efficient user experiences. </p>
                <div className='space-y-4'>
                    <div className='flex items-center'>
                        <label htmlFor="htmlandcsss" className='w-2/12'>HTML & CSS</label>
                    ...
                    <div className='flex items-center'>
                        <label htmlFor="htmlandcsss" className='w-2/12'>React JS</label>
                        <div className='grow bg-gray-800 rounded-full h-2.5'>
                    ...
                    <div className='flex items-center'>
                        <label htmlFor="htmlandcsss" className='w-2/12'>Python</label>
                        <div className='grow bg-gray-800 rounded-full h-2.5'>
                ...
                <div className='mt-12 flex justify-between text-center'>
                    ...
                    <div>
                        <h3 className='text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>15+</h3>
