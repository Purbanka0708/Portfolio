...
const services = [
  ...
  },
  {
    ...
    description:"Combining frontend and backend development for end-to-end web solutions.",
  },
  {
    id:5,
    title:"Content Writing",
    description:"Writing engaging and informative content for various platforms.",
  },
];
const Service=()=> {
  return (
